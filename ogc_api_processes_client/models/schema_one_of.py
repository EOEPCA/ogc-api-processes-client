        ...
        _obj = cls.model_validate(
            {
                ...
                if obj.get("minItems") is not None
                else 0,
                ...
                "enum": obj.get("enum"),
                "type": obj.get("type"),
                "not": SchemaOneOfNot.from_dict(obj["not"])
                if obj.get("not") is not None
                else None,
                "allOf": [SchemaOneOfNot.from_dict(_item) for _item in obj["allOf"]]
                if obj.get("allOf") is not None
                else None,
                "oneOf": [SchemaOneOfNot.from_dict(_item) for _item in obj["oneOf"]]
                if obj.get("oneOf") is not None
                else None,
                "anyOf": [SchemaOneOfNot.from_dict(_item) for _item in obj["anyOf"]]
                if obj.get("anyOf") is not None
                else None,
                "items": SchemaOneOfNot.from_dict(obj["items"])
                ...
                "additionalProperties": SchemaOneOfAdditionalProperties.from_dict(
                ...
                if obj.get("nullable") is not None
                else False,
                "readOnly": obj.get("readOnly")
                if obj.get("readOnly") is not None
                else False,
                "writeOnly": obj.get("writeOnly")
                if obj.get("writeOnly") is not None
                else False,
...
from ogc_api_processes_client.models.schema_one_of_additional_properties import (  # noqa: E402
    SchemaOneOfAdditionalProperties,
)
from ogc_api_processes_client.models.schema_one_of_not import SchemaOneOfNot  # noqa: E402
