...
class Process(BaseModel):
    ...
    additional_parameters: Optional[DescriptionTypeAdditionalParameters] = Field(
    ...
    output_transmission: Optional[List[TransmissionMode]] = Field(
        default=None, alias="outputTransmission"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "additionalParameters": DescriptionTypeAdditionalParameters.from_dict(
                    obj["additionalParameters"]
                )
                ...
                "links": [Link.from_dict(_item) for _item in obj["links"]]
