# Module ogc_api_processes_client.models.input_description_all_of_max_occurs
...
```python3
INPUTDESCRIPTIONALLOFMAXOCCURS_ONE_OF_SCHEMAS
```
...
```python3
class InputDescriptionAllOfMaxOccurs(
    *args,
    **kwargs
)
```
...
def to_dict(
    self
) -> 'Optional[Union[Dict[str, Any], int, str]]'
```
