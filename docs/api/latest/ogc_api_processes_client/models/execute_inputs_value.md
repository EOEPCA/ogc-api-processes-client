# Module ogc_api_processes_client.models.execute_inputs_value
...
```python3
EXECUTEINPUTSVALUE_ONE_OF_SCHEMAS
```
...
def to_dict(
    self
) -> 'Optional[Union[Dict[str, Any], InlineOrRefData, List[InlineOrRefData]]]'
```
