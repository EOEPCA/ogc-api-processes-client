# Module ogc_api_processes_client.models.schema_one_of_additional_properties
...
```python3
SCHEMAONEOFADDITIONALPROPERTIES_ONE_OF_SCHEMAS
```
...
```python3
class SchemaOneOfAdditionalProperties(
    *args,
    **kwargs
)
```
...
def to_dict(
    self
) -> 'Optional[Union[Dict[str, Any], ModelSchema, Reference, bool]]'
```
