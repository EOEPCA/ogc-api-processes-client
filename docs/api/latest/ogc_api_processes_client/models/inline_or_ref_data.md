# Module ogc_api_processes_client.models.inline_or_ref_data
...
```python3
INLINEORREFDATA_ONE_OF_SCHEMAS
```
...
def to_dict(
    self
) -> 'Optional[Union[Dict[str, Any], InputValueNoObject, Link, QualifiedInputValue]]'
```
