# Module ogc_api_processes_client.models.additional_parameter_value_inner
...
```python3
ADDITIONALPARAMETERVALUEINNER_ONE_OF_SCHEMAS
```
...
```python3
class AdditionalParameterValueInner(
    *args,
    **kwargs
)
```
...
def to_dict(
    self
) -> 'Optional[Union[Dict[str, Any], List[object], float, int, object, str]]'
```
