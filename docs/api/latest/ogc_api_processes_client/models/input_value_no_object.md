# Module ogc_api_processes_client.models.input_value_no_object
...
```python3
INPUTVALUENOOBJECT_ONE_OF_SCHEMAS
```
...
def to_dict(
    self
) -> 'Optional[Union[Dict[str, Any], Bbox, List[str], bool, bytes, float, int, str]]'
```
