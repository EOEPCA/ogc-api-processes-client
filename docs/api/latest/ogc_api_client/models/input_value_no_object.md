# Module ogc_api_client.models.input_value_no_object
...
| __pydantic_fields__ | None | A dictionary of field names and their corresponding [`FieldInfo`][pydantic.fields.FieldInfo] objects. | None |
| __pydantic_computed_fields__ | None | A dictionary of computed field names and their corresponding [`ComputedFieldInfo`][pydantic.fields.ComputedFieldInfo] objects. | None |
...
* ogc_api_client.models.input_value_no_object.InputValueNoObject
...
* ogc_api_client.models.input_value_no_object.BaseModel
* pydantic.main.BaseModel
...
def to_dict(
    self
) -> 'Optional[Union[Dict[str, Any], Bbox, List[str], bool, bytearray, float, int, str]]'
```
